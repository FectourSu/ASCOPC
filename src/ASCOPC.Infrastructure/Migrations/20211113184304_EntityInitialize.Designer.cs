...
namespace ASCOPC.Infrastructure.Migrations
{
    ...
    [Migration("20211113184304_EntityInitialize")]
            ...
            modelBuilder.Entity("ASCOPC.Domain.Entities.Component", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = 1372637,
                            CreateAt = new DateTime(2021, 11, 13, 21, 43, 4, 573, DateTimeKind.Local).AddTicks(8028),
            ...
            modelBuilder.Entity("ASCOPC.Domain.Entities.ComponentType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2021, 11, 13, 21, 43, 4, 573, DateTimeKind.Local).AddTicks(8014),
                            Name = "Процессор",
                            UpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("ASCOPC.Domain.Entities.Manufacturer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2021, 11, 13, 21, 43, 4, 573, DateTimeKind.Local).AddTicks(7815),
                            Name = "AMD",
                            UpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            CreateAt = new DateTime(2021, 11, 13, 21, 43, 4, 573, DateTimeKind.Local).AddTicks(7823),
                            Name = "Intel",
                            UpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("ASCOPC.Domain.Entities.Specifications", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2021, 11, 13, 21, 43, 4, 573, DateTimeKind.Local).AddTicks(7999),
