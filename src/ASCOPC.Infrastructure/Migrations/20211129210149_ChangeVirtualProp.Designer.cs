...
namespace ASCOPC.Infrastructure.Migrations
{
    ...
    [Migration("20211129210149_ChangeVirtualProp")]
    partial class ChangeVirtualProp
    {
            ...
            modelBuilder.Entity("ASCOPC.Domain.Entities.Component", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = 1372637,
                            CreateAt = new DateTime(2021, 11, 30, 0, 1, 48, 458, DateTimeKind.Local).AddTicks(2424),
            ...
            modelBuilder.Entity("ASCOPC.Domain.Entities.ComponentType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2021, 11, 30, 0, 1, 48, 458, DateTimeKind.Local).AddTicks(2402),
                            Name = "Процессор",
                            UpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("ASCOPC.Domain.Entities.Manufacturer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2021, 11, 30, 0, 1, 48, 458, DateTimeKind.Local).AddTicks(2211),
                            Name = "AMD",
                            UpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            CreateAt = new DateTime(2021, 11, 30, 0, 1, 48, 458, DateTimeKind.Local).AddTicks(2224),
                            Name = "Intel",
                            UpdateAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("ASCOPC.Domain.Entities.Specifications", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2021, 11, 30, 0, 1, 48, 458, DateTimeKind.Local).AddTicks(2381),
